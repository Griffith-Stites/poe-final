...
void setup() {
  ...
  rotate2.write(to23r(fAngle));
  rotate3.write(to23r(fAngle));
...
void loop() {
  rotate1.write(to14r(fAngle));
  rotate2.write(to23r(bAngle));
  rotate3.write(to14r(bAngle));
  rotate4.write(to23r(fAngle));
  ...
  rotate1.write(to14r(bAngle));
  rotate2.write(to23r(fAngle));
  rotate3.write(to14r(fAngle));
  rotate4.write(to23r(bAngle));
